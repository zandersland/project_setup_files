...
if inputYN_basic_folder_structure == "y":
    check_1 = input(
        "Are you in the right folder? (All folders and files are created from \"./\"): ").lower()
    if check_1 == "y":
        pass
    else:
        print("Answered: ({}).   Exiting...".format(check_1))
        exit(1)
inputYN_gitignore_creation = input("Create or modify .gitignore?: ").lower()
...
def main_func():
    ...
    if inputYN_gitignore_creation == "y":
        gitignore_creation()
